...
class PedidosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pedido" do
    assert_difference('Pedido.count') do
      post pedidos_url, params: { pedido: { data: @pedido.data, pessoa: @pedido.pessoa, sexo: @pedido.sexo } }
    end
  ...
  test "should update pedido" do
    patch pedido_url(@pedido), params: { pedido: { data: @pedido.data, pessoa: @pedido.pessoa, sexo: @pedido.sexo } }
