...
class PedidosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pedido" do
    assert_difference('Pedido.count') do
      post pedidos_url, params: { pedido: { data: @pedido.data, genero: @pedido.genero, idade: @pedido.idade, quantidade: @pedido.quantidade } }
    end
  ...
  test "should update pedido" do
    patch pedido_url(@pedido), params: { pedido: { data: @pedido.data, genero: @pedido.genero, idade: @pedido.idade, quantidade: @pedido.quantidade } }
